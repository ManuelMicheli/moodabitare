    ...
    <AnimatePresence>
      {isVisible && (
        <motion.a
          ...
          className="fixed right-6 z-[70] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#20BD5A] transition-all duration-300"
          style={bottomStyle}
