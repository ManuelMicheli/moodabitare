            ...
            <div className="sticky bottom-0 left-0 right-0 z-[9998] border-t border-black-deep/10 bg-white px-6 pt-4 shadow-[0_-4px_20px_rgba(0,0,0,0.08)]" style={{ paddingBottom: `calc(1.25rem + env(safe-area-inset-bottom, 0px))` }}>
              <div className="flex gap-3">
                <Link
                  href="/contatti"
                  onClick={handleClose}
                  className="flex-1 bg-black-deep text-white text-center py-4 text-button btn-press min-h-[48px] flex items-center justify-center"
                >
                  Richiedi preventivo
                </Link>
                <a
                  ...
                  className="flex items-center justify-center w-[52px] min-h-[48px] bg-[#25D366] text-white rounded"
                  aria-label="WhatsApp"
                >
