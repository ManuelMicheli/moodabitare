...
import type { PorteInterneSubCategory } from "@/lib/porte-interne-categories";
...
function CategoryNav({
  ...
  categories: PorteInterneSubCategory[];
  activeId: string;
...
/* ── Main component ─────────────────────────── */
function PorteInterneCatalogInner({
  categories,
  details,
}: {
  categories: PorteInterneSubCategory[];
    ...
    <section className="py-20 sm:py-28 lg:py-36">
      <div className="px-6 sm:px-10 lg:px-20">
        ...
        <TextRevealByWord
          ...
          stagger={0.05}
        >
          Porte interne Pail e Door Arreda
        </TextRevealByWord>
        ...
        <div className="mt-5 sm:mt-6"><BrandLinks brands="Pail / Door Arreda" /></div>
          ...
          <div className="mt-8 space-y-6 lg:space-y-0">
            <div className="flex flex-wrap items-center gap-8 sm:gap-12 lg:gap-16">
              {[
                ...
                { n: categories.length, label: "Collezioni" },
              ...
              <div className="hidden lg:block">
                <RequestQuoteBanner productName="porte interne" />
              </div>
            </div>
...
export function PorteInterneCatalog(props: {
  categories: PorteInterneSubCategory[];
  details: Record<string, ProductDetail>;
}) {
  return (
    <Suspense>
      <PorteInterneCatalogInner {...props} />
    </Suspense>
  );
}
