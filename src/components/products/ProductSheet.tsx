      ...
      {detail && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={onClose}
              className="absolute top-4 right-4 z-20 w-9 h-9 flex items-center justify-center rounded-full bg-black-deep/5 hover:bg-black-deep/10 transition-colors"
              aria-label="Chiudi"
            >
            ...
            <div className="overflow-y-auto overscroll-contain flex-1">
              ...
              <div className="px-6 pb-8 pt-4">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <h3 className="font-display text-2xl font-bold tracking-tight text-black-deep">
                      {detail.name}
                    </h3>
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-2 gap-x-4 gap-y-0">
                    {specs(detail).map((s) => (
                      <div
                        key={s.label}
                        className="flex flex-col py-2.5 border-b border-black-deep/5"
                      >
                        <span className="text-[0.7rem] font-ui text-black-deep/35 uppercase tracking-wide">
                          {s.label}
                        </span>
                        <span className="text-sm font-medium text-black-deep mt-0.5">
                          {s.value}
                        </span>
                      </div>
                    ))}
                  ...
                  <div className="py-2.5">
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-1.5">
                      {detail.openingTypes.map((type) => (
                        <span
                          key={type}
                          className="text-[0.7rem] font-ui text-black-deep/50 bg-black-deep/[0.03] px-2 py-0.5 rounded"
                        >
                          {type}
                        </span>
                      ))}
            ...
            {/* Sticky CTA */}
            <div className="border-t border-black-deep/5 px-6 py-4 bg-white flex gap-3">
              <a
                href="/contatti"
              ...
              <a
                ...
                className="flex items-center justify-center w-12 border border-black-deep/10 text-black-deep/60 hover:border-black-deep/30 transition-colors"
              >
