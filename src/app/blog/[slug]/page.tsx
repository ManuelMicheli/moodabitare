      ...
      <article>
        ...
        <section className="relative min-h-[60vh] flex items-end bg-black-deep text-white">
          <div className="relative z-10 w-full pb-14 lg:pb-28 px-6 sm:px-10 lg:px-20">
            <FadeInView>
              <Link href="/blog" className="inline-flex items-center gap-2 text-label text-white/80 hover:text-white/60 transition-colors mb-8">
                ← Blog
              </Link>
              <span className="block text-label text-white/80 mb-4">
                Blog
              </span>
              <h1 className="font-section-title max-w-3xl">
                {title}
              </h1>
              <p className="mt-6 text-caption text-white/80">
        ...
        <section className="py-20 lg:py-28">
          <div className="max-w-3xl mx-auto px-6 sm:px-10 lg:px-20">
            <FadeInView>
              <div className="space-y-6 text-caption text-black-deep leading-[1.8]">
