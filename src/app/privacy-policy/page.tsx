...
export const metadata: Metadata = {
  ...
  description: "Informativa sulla privacy e cookie policy di Moschiano Srl.",
};
            ...
            <div className="space-y-10">
              <div>
                <p className="text-caption text-black-deep/40 leading-[1.8]">
                  La presente informativa descrive le modalità di trattamento dei dati personali degli utenti che consultano il sito web www.moschianosrl.it, di proprietà di Moschiano Srl.
                </p>
              </div>

              {[
                { title: "Titolare del trattamento", content: "Il Titolare del trattamento dei dati personali è Moschiano Srl, con sede in Viale Europa, 65 — 21050 Gorla Maggiore (VA), Italia. Email: info@moschianosrl.it" },
                ...
                { title: "Diritti dell'utente", content: "L'utente può esercitare i diritti previsti dal GDPR (accesso, rettifica, cancellazione, limitazione, portabilità, opposizione) contattando il Titolare all'indirizzo info@moschianosrl.it." },
              ].map((section) => (
