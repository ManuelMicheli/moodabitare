...
export const productGalleryImages: Record<string, GalleryImage[]> = {
  ...
  "porte-interne": [
    ...
    { src: "/prodotti/pail-luna-doppia.jpeg", name: "Pail — Luna" },
    ...
    { src: "/prodotti/doorarreda-pandora-classic.jpg", name: "Door Arreda — Seven" },
    { src: "/prodotti/doorarreda-seven.jpg", name: "Door Arreda — Meraki Elysia" },
    { src: "/prodotti/doorarreda-meraki.jpg", name: "Door Arreda — Tineo" },
  ],
  "porte-blindate": [
    ...
    { src: "/prodotti/erreci-ischia-main.jpg", name: "Erreci — Capri Serrature" },
  ],
