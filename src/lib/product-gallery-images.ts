...
export const productGalleryImages: Record<string, GalleryImage[]> = {
  ...
  "gazebi-strutture-legno": [
    { src: "/prodotti/gazebi-autoportante.jpg", name: "Gazebo Autoportante" },
    { src: "/prodotti/gazebi-carport-legno.jpg", name: "Carport in Legno" },
    { src: "/prodotti/gazebi-pergolato-addossato.jpg", name: "Pergolato Addossato" },
    { src: "/prodotti/gazebi-pergolato-pranzo.jpg", name: "Pergolato con Pranzo" },
  ],
  "piscine": [
    { src: "/prodotti/piscine-cemento-armato.jpg", name: "Interrata in Cemento Armato" },
    { src: "/prodotti/piscine-prefabbricata.jpg", name: "Interrata Prefabbricata" },
    { src: "/prodotti/piscine-fuori-terra.jpg", name: "Fuori Terra con Deck" },
    { src: "/prodotti/piscine-solarium.jpg", name: "Piscina con Solarium Integrato" },
  ],
  "rivestimento-piscine": [
    { src: "/prodotti/rivestimento-pvc-armato.jpg", name: "Rivestimento in PVC Armato" },
    { src: "/prodotti/rivestimento-mosaico.jpg", name: "Rivestimento in Mosaico Vetroso" },
    { src: "/prodotti/rivestimento-pietra.jpg", name: "Rivestimento in Pietra Ricostruita" },
  ],
  "arredo-giardino": [
    { src: "/prodotti/giardino-set-pranzo.jpg", name: "Set Pranzo da Esterno" },
    { src: "/prodotti/giardino-lounge.jpg", name: "Divani e Lounge da Giardino" },
    { src: "/prodotti/giardino-bbq.jpg", name: "Barbecue e Cucine Outdoor" },
    { src: "/prodotti/giardino-complementi.jpg", name: "Complementi e Illuminazione" },
  ],

  /* ── Impianti ────────────────────────────── */
  "impianti-fotovoltaici": [
    { src: "/prodotti/fotovoltaico-3kwp.jpg", name: "Impianto Residenziale 3 kWp" },
    { src: "/prodotti/fotovoltaico-6kwp.jpg", name: "Impianto Residenziale 6 kWp" },
    { src: "/prodotti/fotovoltaico-installazione.jpg", name: "Pannelli Monocristallini Premium" },
    { src: "/prodotti/fotovoltaico-premium.jpg", name: "Impianto Integrato a Tetto" },
  ],
  "impianti-elettrici": [
    { src: "/prodotti/elettrico-civile.jpg", name: "Impianto Civile Nuovo" },
    { src: "/prodotti/elettrico-adeguamento.jpg", name: "Adeguamento e Messa a Norma" },
    { src: "/prodotti/elettrico-domotico.jpg", name: "Impianto Domotico" },
