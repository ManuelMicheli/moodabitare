...
export const MACRO_CATEGORIES: MacroCategory[] = [
  {
    id: "serramenti-porte",
    label: "Serramenti & Porte",
    products: [
      { slug: "finestre-pvc-oknoplast", name: "Finestre in PVC", brand: "Oknoplast", macroCategoryId: "serramenti-porte" },
      { slug: "finestre-alluminio-oknoplast", name: "Finestre in Alluminio", brand: "Oknoplast", macroCategoryId: "serramenti-porte" },
      { slug: "serramenti-legno-giannattasio", name: "Serramenti in Legno", brand: "Giannattasio", macroCategoryId: "serramenti-porte" },
      { slug: "porte-interne-bertolotto", name: "Porte Interne", brand: "Bertolotto", macroCategoryId: "serramenti-porte" },
      { slug: "portoncini-alluminio-oknoplast", name: "Portoncini in Alluminio", brand: "Oknoplast", macroCategoryId: "serramenti-porte" },
      { slug: "porte-blindate-alias", name: "Porte Blindate", brand: "Alias", macroCategoryId: "serramenti-porte" },
    ],
  },
  {
    id: "oscuranti-comfort",
    label: "Oscuranti & Comfort",
    products: [
      { slug: "avvolgibili-pasini", name: "Avvolgibili", brand: "Pasini", macroCategoryId: "oscuranti-comfort" },
      { slug: "persiane-erreci", name: "Persiane", brand: "Erreci Sicurezza", macroCategoryId: "oscuranti-comfort" },
      { slug: "monoblocchi-vmc-alpac", name: "Monoblocchi e VMC", brand: "Alpac", macroCategoryId: "oscuranti-comfort" },
      { slug: "grate-inferriate-alias", name: "Grate e Inferriate", brand: "Alias", macroCategoryId: "oscuranti-comfort" },
      { slug: "tende-tecniche-sharknet", name: "Tende Tecniche e Plissé", brand: "Sharknet", macroCategoryId: "oscuranti-comfort" },
      { slug: "zanzariere-zanzar-sistem", name: "Zanzariere", brand: "Zanzar Sistem", macroCategoryId: "oscuranti-comfort" },
    ],
  },
  {
    id: "cucine-arredobagno",
    label: "Cucine & Arredobagno",
    products: [
      { slug: "cucine-cucinesse", name: "Cucine su Misura", brand: "Cucinesse", macroCategoryId: "cucine-arredobagno" },
      { slug: "arredo-bagno-merati", name: "Arredo Bagno", brand: "Merati", macroCategoryId: "cucine-arredobagno" },
      { slug: "sanitari-rubinetteria-karag", name: "Sanitari e Rubinetteria", brand: "Karag", macroCategoryId: "cucine-arredobagno" },
      { slug: "parquet-laminati-skema", name: "Parquet e Laminati", brand: "Skema", macroCategoryId: "cucine-arredobagno" },
      { slug: "scale-ringhiere-fontanot", name: "Scale e Ringhiere", brand: "Fontanot", macroCategoryId: "cucine-arredobagno" },
    ],
  },
];
