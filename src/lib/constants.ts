...
export const MACRO_CATEGORIES: MacroCategory[] = [
  ...
  },
  {
    ...
    label: "Casa & Arredo",
    products: [
      { slug: "cucine-su-misura", name: "Cucine su Misura", brand: "Atra Cucine / Essebi Cucine", macroCategoryId: "casa-arredo" },
...
export const BRAND_PARTNERS = [
  ...
  { name: "Atra Cucine", category: "Cucine su misura", color: "#C41E3A" },
  { name: "Essebi Cucine", category: "Cucine su misura", color: "#5A5A5A" },
...
export const BRAND_URLS: Record<string, string> = {
  ...
  "Atra Cucine": "https://www.atracucine.it/",
  "Essebi Cucine": "https://essebicucine.com/",
